#!/usr/bin/env python3
"""
corpus_construction_split_v6_bk_maxn_followup.py -- corpus-fix-8-followup.
...
applied to CORPUS_MANIFEST_V6.json (corpus-fix-8's ~150-company expansion).
...
MANIFEST_V6 = REPO / "analysis/data/corpus_v2/CORPUS_MANIFEST_V6.json"
PRIOR_SPLIT = REPO / "analysis/data/corpus_v2/SPLIT_V5_EXPANSION.json"
SEED = 20201231
...
def main():
    manifest = json.loads(MANIFEST_V6.read_text())
    ...
    result = {
        ...
        "seed": SEED,
        "manifest_source": "analysis/data/corpus_v2/CORPUS_MANIFEST_V6.json (corpus-fix-8 followup: "
                            "BK->BNY and MAXN->MAXNQ identity-resolved and added)",
        ...
        "old_holdout_sha256_v5_159_companies": prior["holdout_sha256"],
        "new_holdout_sha256_v6_161_companies": holdout_sha256,
    }
    out_path = REPO / "analysis/data/corpus_v2/SPLIT_V6_BK_MAXN_FOLLOWUP.json"
