#!/usr/bin/env python3
"""One-time: pull FSLR + RUN daily closes from yfinance and merge into
data/price_cache.json. Run this on your laptop where yfinance isn't proxied.

Usage:
    cd analysis && python3 fetch_prices_FSLR_RUN.py
"""
...
TICKERS = ["FSLR", "RUN"]
START = "2020-01-01"   # matches the rest of the cache for full σ windows
END = None             # today
