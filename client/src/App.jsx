...
function Evaluator() {
  ...
  // Metadata populated after analysis, editable before save
  ...
  async function handleAnalyze() {
    ...
    try {
      ...
      // Only fill fields the user left blank — never overwrite user-typed values
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 24px' }}>
      ...
      {/* Metadata panel — always visible, populated after analysis */}
      <div style={{
        padding: '20px',
        background: '#161b27',
        border: '1px solid #2d3748',
